...
namespace UnityGGPO {
    ...
    public static partial class GGPO {
        ...
        public static class Session {
            ...
            public delegate bool SafeLoadGameStateDelegate(List<byte> data);

            public delegate bool SafeLogGameStateDelegate(string filename, List<byte> data);

            public delegate bool SafeSaveGameStateDelegate(out List<byte> data, out int checksum, int frame);

            public delegate void SafeFreeBufferDelegate(List<byte> data);

            private static IntPtr ggpo;
            private static readonly Dictionary<long, List<byte>> cache = new Dictionary<long, List<byte>>();
